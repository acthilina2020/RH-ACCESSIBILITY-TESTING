...
const tests = [
    ...
    },
    {
		...
		testOptions: {
			actions: [
				'wait for element #listing-cta-button to be visible'
			],
			ignore: [
				'warning', 'notice'
			],
    ...
    },
    {
		...
		testOptions: {
			actions: [
				'wait for element #location-list-sort to be visible'
            ],
            timeout: 60000,
			ignore: [
				'notice', 'warning'
    ...
    },
    {
		...
		testOptions: {
            ...
            timeout: 80000,
            //screenCapture: __dirname + '/output/mortgagePage.png',
			ignore: [
				'warning', 'notice'
			],
			log: {
    ...
    },
    {
		...
		testOptions: {
			actions: [
				...
				'wait for #buy__sell-home > div > a to be visible',
                'wait for #lead-form > div.col-xs-12.paddingX8.paddingY16.clearfix.textCenter > button to be visible'
            ],
            timeout: 70000,
            //screenCapture: __dirname + '/output/buyPage.png',
			ignore: [
				'warning', 'notice'
			],
			log: {
    ...
    },
    {
		...
		testOptions: {
			actions: [
				...
				'wait for #lead-form > div.col-xs-12.paddingX8.paddingY16.clearfix.textCenter > button to be visible',
                'wait for #sell__buy-home > div > a to be visible'
			],
			ignore: [
				'warning', 'notice'
			],
	...
	},
    {
		...
		testOptions: {
			actions: [
                ...
                'wait for element #app > div > div.marketing-content.zIndex0 > div > div.container_8080.bgcareerscta > div > div:nth-child(2) > div > a to be visible'
			],
			ignore: [
				'warning', 'notice'
			],
